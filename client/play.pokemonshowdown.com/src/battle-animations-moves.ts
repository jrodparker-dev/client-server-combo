...
// Custom move aliases
BattleMoveAnims['earthrend'] = {anim: BattleMoveAnims['earthquake'].anim};
BattleMoveAnims['lunartide'] = {anim: BattleMoveAnims['surf'].anim};
BattleMoveAnims['drillram'] = {anim: BattleMoveAnims['drillrun'].anim};
BattleMoveAnims['lotusfist'] = {anim: BattleMoveAnims['drainpunch'].anim};
BattleMoveAnims['naturesresolve'] = {anim: BattleMoveAnims['bulkup'].anim};
BattleMoveAnims['midnightslash'] = {anim: BattleMoveAnims['nightslash'].anim};
BattleMoveAnims['feathercloak'] = {anim: BattleMoveAnims['agility'].anim};
BattleMoveAnims['toxicmaw'] = {anim: BattleMoveAnims['poisonfang'].anim};
BattleMoveAnims['scaleguard'] = {anim: BattleMoveAnims['irondefense'].anim};
BattleMoveAnims['ironrend'] = {anim: BattleMoveAnims['ironhead'].anim};
BattleMoveAnims['shadowrend'] = {anim: BattleMoveAnims['nightslash'].anim};
BattleMoveAnims['armorlock'] = {anim: BattleMoveAnims['block'].anim};
BattleMoveAnims['clarityveil'] = {anim: BattleMoveAnims['lightscreen'].anim};
BattleMoveAnims['sporeguard'] = {anim: BattleMoveAnims['spore'].anim};
BattleMoveAnims['solarvortex'] = {anim: BattleMoveAnims['solarbeam'].anim};
BattleMoveAnims['beautycoil'] = {anim: BattleMoveAnims['coil'].anim};
BattleMoveAnims['rootguard'] = {anim: BattleMoveAnims['ingrain'].anim};
BattleMoveAnims['venomfangs'] = {anim: BattleMoveAnims['poisonfang'].anim};
BattleMoveAnims['strikingstorm'] = {anim: BattleMoveAnims['hurricane'].anim};
BattleMoveAnims['spiritbeam'] = {anim: BattleMoveAnims['shadowball'].anim};
BattleMoveAnims['revvingdrill'] = {anim: BattleMoveAnims['drillrun'].anim};
BattleMoveAnims['swarmguard'] = {anim: BattleMoveAnims['quiverdance'].anim};
BattleMoveAnims['chromaticclaw'] = {anim: BattleMoveAnims['slash'].anim};
BattleMoveAnims['capcrush'] = {anim: BattleMoveAnims['woodhammer'].anim};
BattleMoveAnims['toxicslash'] = {anim: BattleMoveAnims['crosspoison'].anim};
BattleMoveAnims['disorientingbite'] = {anim: BattleMoveAnims['crunch'].anim};
BattleMoveAnims['serenefocus'] = {anim: BattleMoveAnims['calmmind'].anim};
BattleMoveAnims['nuclearexplosion'] = {anim: BattleMoveAnims['explosion'].anim};
BattleMoveAnims['ultimateslam'] = {anim: BattleMoveAnims['gigaimpact'].anim};
